...
class ReplaceValuesAtXPathsInTheirs(BaseTest):
    ...
    def test_all_xpath_present_but_unchanged_in_all(self):
        ...
        ancestor_o_xml_str = self.ancestor_o_xml_str
        theirs_b_xml_str = ancestor_o_xml_str
        ours_a_xml_str = ancestor_o_xml_str

        modified_theirs_b_xml_str, errors = replace_values_at_xpaths_in_theirs(
            xpaths_to_be_replaced, ancestor_o_xml_str, ours_a_xml_str, theirs_b_xml_str)

        expected_xml_str = ancestor_o_xml_str

        self.assertEqual(expected_xml_str, modified_theirs_b_xml_str)
        self.assertEqual(0, len(errors), errors)

    def test_changes_in_ours_only(self):
        xpaths_to_be_replaced = [
            './version',
            './parent/version',
            './properties/revision'
        ...
        theirs_b_xml_str = ancestor_o_xml_str
        # In Ours, the XPaths project/parent/version, project/version, and project/properties/revision are changed.
    ...
    def test_xpath_missing_in_ours(self):
        xpaths_to_be_replaced = [
            './version',
            './parent/version',  # Missing in Ours.
            './properties/revision'
        ]
    ...
    def test_xpath_missing_in_theirs(self):
        ...
        # Without project/parent on purpose.
    ...
    def test_xpath_ambiguous_in_ours(self):
        xpaths_to_be_replaced = [
